    ...
    <div className="h-screen w-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-lg px-8">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          {/* SAML SSO Section - Single button using first enabled config */}
              ...
              <div className="mt-6">
                <button
                  ...
                  onClick={() => {
                    ...
                    // Use Azure AD MyApps link with tenant_id and client_id from config
                    const tenantId = provider.tenant_id || provider.allowed_domains?.split(',')[0] || '';
                    // Extract client_id from issuer_url or use a stored client_id
                    // Issuer URL format: https://sts.windows.net/{tenant-id}/
                    // We need the SAML app client_id from the config
                    ...
                    if (tenantId && clientId) {
                      ...
                      // Fallback to our SAML login endpoint
